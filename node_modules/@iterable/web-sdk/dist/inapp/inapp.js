(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "throttle-debounce", "lodash/set", "../request", "./utils", "../events", "../constants", "./inapp.schema"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("throttle-debounce"), require("lodash/set"), require("../request"), require("./utils"), require("../events"), require("../constants"), require("./inapp.schema"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.throttleDebounce, global.set, global.request, global.utils, global.events, global.constants, global.inapp);
    global.inapp = mod.exports;
  }
})(typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : this, function (_exports, _throttleDebounce, _set, _request, _utils, _events, _constants, _inapp) {
  "use strict";
  ...
  function getInAppMessages(payload, showInAppMessagesAutomatically) {
    ...
    if (showInAppMessagesAutomatically) {
      ...
      const paintMessageToDOM = () => {
        ...
        if ((_parsedMessages = parsedMessages) !== null && _parsedMessages !== void 0 && _parsedMessages[messageIndex]) {
          ...
          const dismissMessage = (activeIframe, url) => {
            ...
            (0, _events.trackInAppClose)(url ? _objectSpread(_objectSpread({}, trackPayload), {}, {
              clickedUrl: url
            }) : trackPayload).catch(e => e);
          ...
          return (0, _utils.paintIFrame)(activeMessage.content.html, position, shouldAnimate, payload.onOpenScreenReaderMessage || 'in-app iframe message opened', payload.topOffset, payload.bottomOffset, payload.rightOffset).then(activeIframe => {
            var _activeIframe$content10, _payload$closeButton, _activeIframe$content14, _activeIframe$content17, _activeIframe$content18;
            ...
            */
            ...
            if (!((_payload$closeButton = payload.closeButton) !== null && _payload$closeButton !== void 0 && _payload$closeButton.isRequiredToDismissMessage)) {
            ...
            if ((_activeIframe$content14 = activeIframe.contentWindow) !== null && _activeIframe$content14 !== void 0 && _activeIframe$content14.document) {
              ...
              */
              ...
              if (payload.closeButton) {
                var _payload$closeButton2, _payload$closeButton3, _payload$closeButton4, _payload$closeButton5;

                const newButton = (0, _utils.generateCloseButton)(document, (_payload$closeButton2 = payload.closeButton) === null || _payload$closeButton2 === void 0 ? void 0 : _payload$closeButton2.position, (_payload$closeButton3 = payload.closeButton) === null || _payload$closeButton3 === void 0 ? void 0 : _payload$closeButton3.color, (_payload$closeButton4 = payload.closeButton) === null || _payload$closeButton4 === void 0 ? void 0 : _payload$closeButton4.size, (_payload$closeButton5 = payload.closeButton) === null || _payload$closeButton5 === void 0 ? void 0 : _payload$closeButton5.iconPath, payload.closeButton.topOffset, payload.closeButton.sideOffset);
            ...
            */
            ...
            if (_constants.ENABLE_INAPP_CONSUME || _constants.IS_PRODUCTION) {
              ...
              const trackRequests = [(0, _events.trackInAppOpen)(trackPayload), ...(!activeMessage.saveToInbox ? [(0, _events.trackInAppConsume)(trackPayload)] : [])];
            ...
            for (let i = 0; i < links.length; i++) {
              ...
              const isIterableKeywordLink = !!clickedUrl.match(/iterable:\/\/|action:\/\//gim);
              ...
              link.addEventListener('click', event => {
                ...
                */
                ...
                if (clickedUrl) {
                  ...
                  const isOpeningLinkInSameTab = !payload.handleLinks && !openInNewTab || payload.handleLinks === 'open-all-same-tab' || isInternalLink && payload.handleLinks === 'external-new-tab';
                  ...
                  */
                  ...
                  if (isActionLink) {
                    ...
                    const filteredMatch = (_ref = ((_RegExp = new RegExp(/^.*action:\/\/(.*)$/, 'gmi')) === null || _RegExp === void 0 ? void 0 : _RegExp.exec(clickedUrl)) || []) === null || _ref === void 0 ? void 0 : _ref[1];
                    /* 
      ...
      const isDeferred = typeof showInAppMessagesAutomatically !== 'boolean' && showInAppMessagesAutomatically.display === 'deferred';
      const triggerDisplayFn = isDeferred ? {
        triggerDisplayMessages: messages => {
          parsedMessages = (0, _utils.filterHiddenInAppMessages)(messages);
    ...
    */
    ...
    return (0, _request.baseIterableRequest)({
      ...
      (0, _utils.trackMessagesDelivered)(messages || [], dupedPayload.packageName);
      const withIframes = messages === null || messages === void 0 ? void 0 : messages.map(message => {
        var _message$content;

        const html = (_message$content = message.content) === null || _message$content === void 0 ? void 0 : _message$content.html;
        return html ? (0, _set.default)(message, 'content.html', (0, _utils.wrapWithIFrame)(html)) : message;
      });
      return _objectSpread(_objectSpread({}, response), {}, {
