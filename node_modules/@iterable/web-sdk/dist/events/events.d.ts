...
export declare const trackInAppClick: (payload: Omit<InAppEventRequestParams, 'inboxSessionId' | 'closeAction'>, sendBeacon?: boolean) => import("../types").IterablePromise<IterableResponse>;
