(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "./authorization", "./users", "./inapp", "./request", "./events", "./commerce", "./types", "./utils/config"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("./authorization"), require("./users"), require("./inapp"), require("./request"), require("./events"), require("./commerce"), require("./types"), require("./utils/config"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.authorization, global.users, global.inapp, global.request, global.events, global.commerce, global.types, global.config);
    global.index = mod.exports;
  }
})(typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : this, function (_exports, _authorization, _users, _inapp, _request, _events, _commerce, _types, _config) {
  "use strict";
